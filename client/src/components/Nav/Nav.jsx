  ...
  const handleOnClickAbout= event=>{
    ...
    return (
      <nav className={style.nav}>
       <button className={style.navBtn1} onClick={handleOnClickForm} disabled={disableForm}>Submit new Game</button>
        <SearchBar/>
           <button className={style.navBtn2} onClick={handleOnClickHome} disabled={disableHome}>Home</button>
           <button className={style.navBtn3} onClick={handleOnClickAbout} disabled={disableAbout}>About</button>
      </nav>
    )
};
